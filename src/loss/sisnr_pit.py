...
class SiSNR_PIT(nn.Module):
    ...
    def forward(
        ...
        audio_s1_norm = audio_s1.T @ audio_s1
        audio_s2_norm = audio_s2.T @ audio_s2

        audio_s1_target_perm1 = audio_s1 @ pred_audio_s1 / audio_s1_norm * audio_s1
        audio_s2_target_perm1 = audio_s2 @ pred_audio_s2 / audio_s2_norm * audio_s2

        noise_s1_perm1 = pred_audio_s1 - audio_s1_target_perm1
        noise_s2_perm1 = pred_audio_s2 - audio_s2_target_perm1

        si_snr_s1_perm1 = 10 * torch.log10(audio_s1_target_perm1.T @ audio_s1_target_perm1 / noise_s1_perm1.T @ noise_s1_perm1)
        si_snr_s2_perm1 = 10 * torch.log10(audio_s1_target_perm1.T @ audio_s2_target_perm1 / noise_s2_perm1.T @ noise_s2_perm1)
        ...
        audio_s1_target_perm2 = audio_s1 @ pred_audio_s2 / audio_s1_norm * audio_s1
        audio_s2_target_perm2 = audio_s2 @ pred_audio_s1 / audio_s2_norm * audio_s2

        noise_s1_perm2 = pred_audio_s2 - audio_s1_target_perm2
        noise_s2_perm2 = pred_audio_s1 - audio_s2_target_perm2

        si_snr_s1_perm2 = 10 * torch.log10(audio_s1_target_perm2.T @ audio_s1_target_perm2 / noise_s1_perm2.T @ noise_s1_perm2)
        si_snr_s2_perm2 = 10 * torch.log10(audio_s2_target_perm2.T @ audio_s2_target_perm2 / noise_s2_perm2.T @ noise_s2_perm2)
